...
public class ExponentialIntegralEi {
	...
	// careful, needs to be such that Double.min_value + 1.0 != 1.0
	static final double epsilon = 10.0 * Double.MIN_VALUE;
	...
	// //////////////////////////////////////////////////////////////////////////////
//	static double Exponential_Integral_Ei(double x) {
//		return (double) xExponential_Integral_Ei((double) x);
//	}
	...
	static double xExponential_Integral_Ei(double x) {
		...
		if (x == 0.0)
			return -Double.MAX_VALUE; // possible error when flipping sign?
		if (x < 6.8)
	...
	static double Argument_Addition_Series_Ei(double x) {
		double[] ei = { 1.915047433355013959531e2, 4.403798995348382689974e2,
